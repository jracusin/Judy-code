...
;           oplot,lctime[wc],yfit[wc],line=2
        ...
        fit_lc,lc=lcc,/nohard,xrange=xrange,yrange=yrange,ytitle=ytitle,ffile='lc_fit_comb.dat',ps=ps,charsize=1.,justplot=justplot,opx=opx,opy=opy,/nochandra,flux=xratio,/nouseflux,int='0';,nsig=1.,int='8'
        if keyword_set(ps) then endplot
        if exist('lc_fit_out_idl_int0.dat') then begin 
           spawn,'cp lc_fit_out_idl_int0.dat lc_fit_comb.dat'
           spawn,'more lc_fit_xrt.dat'
           spawn,'more lc_fit_comb.dat'
           spawn,'rm lc_fit_out_idl_int0.dat'
...
;           oplot,lctime[wc],yfit[wc],line=2
        ...
        fit_lc,/nohard,yrange=yrange,ytitle=ytitle,ffile='lc_fit_xrt.dat',ps=ps,charsize=1.,/justplot,opx=opx,opy=opy,int='0',/chandra
...
;        if not exist('bg.reg') then $
        ...
        bgra=tmpra[0]+':'+tmpra[1]+':'+ntostr(tmpra[2]*1.+3.)
           write_regfile,'bg.reg',ra,dec,'24p','10p',/ann
