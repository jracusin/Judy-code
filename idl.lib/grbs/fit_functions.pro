function fred,t,p
  ...
  t2=t[w]-tstart
  yfit=fltarr(n_elements(t))
  yfit[w]=amp*t2/exp(decay*t2)
  yfit=yfit+back
  
  return,yfit
end 

function cutoff_pow,t,p

  norm=p[0]
  alpha=p[1]
  ep=p[2]

  yfit=norm*t^(-alpha)*exp(-t/ep)

return,yfit
end 

function bkn4pow,t,p,seg=seg,perror=perror,yerror=yerror
  norm=p[0]
  pow1=p[1]
  break1=p[2]
  pow2=p[3]
  ...
  w4=where(t ge break3 and t lt break4,nw4)
  w5=where(t ge break4,nw5)
  ...
  if nw5 gt 0 then $
     yfit[w5]=norm*break1^(pow2-pow1)*break2^(pow3-pow2)*break3^(pow4-pow3)*break4^(pow5-pow4)*t[w5]^(-pow5)
  ...
  if n_elements(perror) gt 0 then begin
     ...
     if nw4 gt 0 then begin 
        ...
        dydb3=norm*t^(-pow4)*(pow4-pow3)*break1^(pow2-pow1)*break2^(pow3-pow2)*break3^(pow4-pow3-1)
     ...
     if nw5 gt 0 then begin 
        dydn=break1^(pow2-pow1)*break2^(pow3-pow2)*break3^(pow4-pow3)*break4^(pow5-pow4)*t^(-pow5)
        dydp1=-norm*alog(break1)*break1^(pow2-pow1)*break2^(pow3-pow2)*break3^(pow4-pow3)*break4^(pow5-pow4)*t^(-pow5)
        dydp2=-norm*alog(break1)*alog(break2)*break1^(pow2-pow1)*break2^(pow3-pow2)*break3^(pow4-pow3)*break4^(pow5-pow4)*t^(-pow5)
        dydp3=-norm*alog(break2)*alog(break3)*break1^(pow2-pow1)*break2^(pow3-pow2)*break3^(pow4-pow3)*break4^(pow5-pow4)*t^(-pow5)
        dydp4=-norm*alog(break3)*alog(break4)*break1^(pow2-pow1)*break2^(pow3-pow2)*break3^(pow4-pow3)*break4^(pow5-pow4)*t^(-pow5)
        dydp5=-norm*alog(t)*alog(break4)*break1^(pow2-pow1)*break2^(pow3-pow2)*break3^(pow4-pow3)*break4^(pow5-pow4)*t^(-pow5)
        dydb1=norm*t^(-pow5)*(pow2-pow1)*break1^(pow2-pow1-1)*break2^(pow3-pow2)*break3^(pow4-pow3)*break4^(pow5-pow4)
        dydb2=norm*t^(-pow5)*(pow3-pow2)*break1^(pow2-pow1)*break2^(pow3-pow2-1)*break3^(pow4-pow3)*break4^(pow5-pow4)
        dydb3=norm*t^(-pow5)*(pow4-pow3)*break1^(pow2-pow1)*break2^(pow3-pow2)*break3^(pow4-pow3-1)*break4^(pow5-pow4)
        dydb4=norm*t^(-pow5)*(pow5-pow4)*break1^(pow2-pow1)*break2^(pow3-pow2)*break3^(pow4-pow3)*break4^(pow5-pow4-1)
        yerr2=normerr^2*dydn^2+pow1err^2*dydp1^2+pow2err^2*dydp2^2+pow3err^2*dydp3^2+pow4err^2*dydp4^2+pow5err^2*dydp5*break1err*dydb1^2+break2err^2*dydb2^2+break3err^2+dydb3^2
        yerror[w5]=sqrt(yerr2[w5])
     endif
  endif 
  return,yfit
end 
...
function pow,t,p,perror=perror,yerror=yerror,terror=terror,tnorm=tnorm
  if n_elements(tnorm) eq 0 then tnorm=1.
  norm=p[0]
  pow1=p[1]
  yfit=norm*(t/tnorm)^(-pow1)
  if n_elements(perror) gt 0 then begin
     normerr=perror[0]
     powerr=perror[1]
     dydn=t^(-pow1)
...
function intbkn4pow,t,p,seg=seg,perror=perror,yerror=yerror
  norm=p[0]
  pow1=p[1]
  break1=p[2]
  pow2=p[3]
  ...
  w4=where(tm ge break3 and tm lt break4,nw4)
  w5=where(tm ge break4,nw5)
  ...
  if nw5 gt 0 then $
     yfit[w5]=norm*break1^(pow2-pow1)*break2^(pow3-pow2)/(1.-pow5)*break3^(pow4-pow3)*break4^(pow5-pow4)*(t2[w5]^(1.-pow5)-t1[w5]^(1.-pow5))
  yfit=yfit/td
...
function intbkn3pow,t,p,seg=seg,perror=perror,yerror=yerror
  ...
  if nw3 gt 0 then $
     yfit[w3]=norm*break1^(pow2-pow1)*break2^(pow3-pow2)/(1.-pow3)*(t2[w3]^(1.-pow3)-t1[w3]^(1.-pow3))
  if nw4 gt 0 then $
     yfit[w4]=norm*break1^(pow2-pow1)*break2^(pow3-pow2)*break3^(pow4-pow3)/(1.-pow4)*(t2[w4]^(1.-pow4)-t1[w4]^(1.-pow4))
  yfit=yfit/td
...
function intpow,t,p,terror=terror,tnorm=tnorm
  if n_elements(tnorm) eq 0 then tnorm=1.
  norm=p[0]
  pow1=p[1]
  t1=t[0,*]/tnorm
...
function cintpow,t,p,terror=terror
  norm=p[0]
  pow1=p[1]
  c=p[2]
  t1=t[0,*]
...
function cintbknpow,t,p,seg=seg
  norm=p[0]
  pow1=p[1]
  break1=p[2]
  pow2=p[3]
...
function cintbkn2pow,t,p,seg=seg,perror=perror,yerror=yerror
  norm=p[0]
  pow1=p[1]
  break1=p[2]
  pow2=p[3]
...
function cintbkn3pow,t,p,seg=seg,perror=perror,yerror=yerror
  norm=p[0]
  pow1=p[1]
  break1=p[2]
  pow2=p[3]
...
function smbknpow,t,p
  norm=p[0]
  pow1=p[1]
  break1=p[2]
  pow2=p[3]
  if n_elements(p) eq 5 then s=p[4] else s=1.
  yfit=norm*(((t/break1)^(s*pow1))+((t/break1)^(s*pow2)))^(-1./s)
...
function int_pow_pow,t,p,fp1,fp2
...
function int_pow_bkn2pow,t,p,f1,f2
...
function beuermann,t,norm1,a1,norm2,a2,n,f1,f2
...
function gauss_bkn2pow,t,p,f1,f2
