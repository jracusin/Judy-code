...
;  regfile=''
  ...
  stop
;  regfile='src_excl16.reg'
;  regfile='src_excl6.reg'
;  regfile='src_excl0.reg'
;  regfile='src_excl14.reg'
;  regfile='srcpc7_30.reg'
;  regfile='srcpc4_25.reg'
;  regfile='srcpc0_20.reg'
;  regfile='srcpc0_25.reg'
;  regfile='srcpc0_15.reg'
;  regfile='srcpc0_12.reg'
;  regfile='srcpc0_10.reg'
  regfile='srcpc0_7.reg'
  
  expomap=stem+'_ex.img'
  arfname=stem+'_nopsf.arf'
  if mode eq 'wt' then begin
     grp='40'
;     respfile='/bulk/pkg/caldb/data/swift/xrt/cpf/rmf/swxwt0to2s6_20010101v010.rmf'
     respfile='swxwt0to2s6_20010101v011.rmf'
  endif 
  if mode eq 'pc' then begin
     respfile='/bulk/pkg/caldb/data/swift/xrt/cpf/rmf/swxpc0to12s6_20010101v011.rmf'
     grp='20'
  endif 
...
;  xrtmkarf='xrtmkarf outfile='+arfname+' phafile='+phaname+' srcx=-1 srcy=-1 psfflag=yes clobber=yes expofile='+expomap+' > xrtmkarf.out'
  xrtmkarf='xrtmkarf outfile='+arfname+' phafile='+phaname+' srcx=-1 srcy=-1 psfflag=no clobber=yes > xrtmkarf.out'
  print,xrtmkarf
  spawn,xrtmkarf
;skip:  
