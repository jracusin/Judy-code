pro cp_goodfiles,seg,excl,n,nocp=nocp
  ...
  sky=file_search(wtdir+'seg'+seg+'_wt_rawinstr.img.gz')
  spawn,'cp '+wtdir+'*bg* .'
...
;  ex=[16,14,14,14,14,14,8,4,0,0]
  ex=[14,14,14,14,10,10,8,0,0,0]
;  ex=[7,7,7,7,7,7,7,7,7,7]
...
;  endfor 
  ...
  trigtime=227599971.904d;227599969.0  
