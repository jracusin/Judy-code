...
pro lat_other,lum=lum,flux=flux,rate=rate
  ...
  if keyword_set(lum) then begin
     lat=['GRB080916C','GRB090323','GRB090328A','GRB090510','GRB090902B','GRB090926A','GRB091003','GRB091208B','GRB100414A','GRB100728A','GRB110731A','GRB120711A','GRB130427A','GRB130518A','GRB130702A','GRB130907A','GRB131108A','GRB131231A','GRB141028A']
     z=[4.35,3.57,0.73,0.903,1.822,2.1062,0.8969,1.0633,1.368,1.567,2.83,1.405,0.34,2.49,0.145,1.2,2.4,0.642,2.33]
