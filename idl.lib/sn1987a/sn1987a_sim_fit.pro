pro sn1987a_sim_fit,im,a,sigma,chisq,dof,iter,fitim,perror,lobes=lobes,ring=ring,ptsrc=ptsrc,bilat=bilat
...
;  sigma=sigma;*sqrt(chisq/dof2)
  ...
  conf_error2d,xpos,ypos,im,err,a,sigma,model,perror,bestfit,pvarunit,bestchisq,yfit,psave,/d2,parinfo=parinfo,wpar=5,weights=weights,/doplot,delchi0=1.
