...
;========================================================================
;;;
;;; Dataset_2D Widget: $Id: dataset_2d.pro 3494 2009-07-17 16:57:13Z patb $
;;;
     ...
     if (pathname NE '') then begin
       ...
       if (Error NE 0) then begin
         ...
         plot_window, (*st).pw_id, XAXIS=xaxis, YAXIS=yaxis
           ...
           sxaddpar, fits_header, "CREATOR", "$RCSfile$, Version $Revision: 3494 $"
    ...
    3: $ ; SAVE DATASET
     ...
     if (pathname NE '') then begin
       ...
       if (Error NE 0) then begin
         ...
         sxaddpar, pheader, "CREATOR", "$RCSfile$, Version $Revision: 3494 $"
