...
# $Id: setup_AE_for_iarray_data.csh 3292 2008-12-17 19:14:34Z patb $

# Script to set up AE obsXXXX directories to point to an observation's Iarray data. 
...
foreach obsid_dir ($1)
  ...
  set source_files = (   iarray_1.emap iarray.validation.evt2 iarray.spectral.evt2 stowed.iarray_1.emap iarray.stowed.evt2 acis.astrometric.asol1 asphist obsid_\*_ardlib.par acis.pbk0    acis.msk1)
