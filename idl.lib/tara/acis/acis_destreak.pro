;;; $Id: acis_destreak.pro 1988 2004-04-15 16:25:56Z patb $
...
if keyword_set(destreak) then begin
  ...
  for ii=0, num_ccds-1 do begin
    ...
    fxaddpar, pheader, 'CREATOR', "$RCSfile$, v$Revision: 1988 $"
    fxaddpar, theader, 'CREATOR', "$RCSfile$, v$Revision: 1988 $"
    ...
    fxaddpar, emap_header, 'CREATOR', "$RCSfile$, v$Revision: 1988 $"
