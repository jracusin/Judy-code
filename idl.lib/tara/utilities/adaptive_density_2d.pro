;;; $Id: adaptive_density_2d.pro 3255 2008-11-18 18:15:36Z patb $
...
PRO adaptive_density_2d, image, min_significance_param, $
			...
			MAX_RADIUS=max_radius, MAX_NUM_KERNELS=max_num_kernels, RADII=radii, FIXED_RADIUS_MAP=fixed_radius_map,$
...
if (image_type EQ 'FLOAT' || image_type EQ 'DOUBLE') then $
