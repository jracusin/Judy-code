...
;========================================================================
;;;
;;; FILE NAME:    $Id: color_manager.pro 3480 2009-07-06 21:20:58Z patb $
;;;
...
if (n_elements(model) EQ 0) then begin
  print, 'Initializing the TARA color manager v$Revision: 3480 $ ...'
  ...
  ; top of the table.
  if (NOT keyword_set(num_reserved)) then num_reserved = 9
  ...
  rc.r    = [    255,          0,     255,     255,    30,      0,    255,      0,   255 ]
  rc.g    = [    255,        255,       0,     128,   144,    255,      0,      0,   255 ]
