...
;  w=where((lat1 gt 0 and lat2 lt 0) or (lat1 lt 0 and lat2 gt 0)) 
  ...
  w2=where(minasdist lt 15 and droll gt drolllim)
  w3=where(cross and minasdist lt 15 and dist gt distlim and droll gt drolllim); and minasecldist lt 15)
...
;  !p.multi=[0,1,3]
  ...
  oplot,[bad,bad],[-1000,1000],line=1
  oplot,[0,10],[drolllim,drolllim],line=1
  
  legend,['All Anti-Sun dist < 15 deg','Old Criteria (cross Ecl)','John criteria ('+!tsym.delta_cap+' roll > '+ntostr(fix(drolllim))+')','New Criteria (cross Ecl, '+!tsym.delta_cap+' roll > '+ntostr(fix(drolllim))+', slew dist > 10)'],box=0,/bottom,/right,textcolor=[!p.color,!red,!blue,!green]
  ...
  oplot,[bad,bad],[-1000,1000],line=1
  oplot,[0,10],[distlim,distlim],line=1
