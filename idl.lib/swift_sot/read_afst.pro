pro read_afst,file,outstr,date=date,includeslew=includeslew
  ...
  while not eof(lun) do begin
     ...
     if n_elements(line) eq 22 then begin 
        line=line[1:*]
        if (line[1] eq 'PPT' or line[1] eq 'AT' or line[1] eq 'ToO' or line[1] eq 'Safe Point') $
        ...
        if line[1] eq 'Slew Settled' and line[2] eq 'Begin' then settime=line[0]
        if (line[1] eq 'PPT' or line[1] eq 'AT' or line[1] eq 'ToO' or line[1] eq 'Safe Point' $ 
