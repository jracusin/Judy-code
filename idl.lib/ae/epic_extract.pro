;;; $Id: epic_extract.pro 3429 2009-06-08 16:02:51Z patb $
;;; EPIC Extract. 
...
creator_string = "epic_extract, version"+strmid("$Date: 2009-06-08 12:02:51 -0400 (Mon, 08 Jun 2009) $", 6, 11)
print, F='(%"\nEPIC Extract: ============================================================")'  
...
;; =============================================================================
  ...
  for ii = 0, num_sources-1 do begin
    ...
    sxdelpar, stats, ['NUM_OBS', 'EMAP_TOT', 'FRACEXPO', 'WARNFRAC', 'OBSNAME', 'PRIM_OBS', 'SRC_CNTS', 'THETA', 'SRC_RAD', 'PSF_FRAC', 'MSK_RAD', 'RA_DATA', 'DEC_DATA', 'RA_ML', 'DEC_ML', 'QUANTCOR', 'RA_CORR', 'DEC_CORR', 'BACKGRND', 'SCAL_MAX', 'SCAL_MIN', 'KS_SPECT', 'EXPOSURE', 'EFFAREA', 'PROB_KS', 'ERR_DATA', 'KS_PSF' ]
