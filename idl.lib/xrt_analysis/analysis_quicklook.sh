...
if (file_size(file) gt 0) then begin & $ 
    stripchart,file,/quicklook & $
    run='  Y   ' & $
endif 
openu,unit,'analysis.log',/get_lun,/append
printf,unit,'stripchart       ',file+'                  ',run,run
close,unit
EOF
...
if (file_size(file) gt 0) then begin & $
   ...
   run='  Y   ' & $
   spawn,'a2ps -1 -r --font-size=8 -Psneezy '+filetxt & $
endif 
openu,unit,'analysis.log',/get_lun,/append
printf,unit,'scanerr          ',file+'               ',run,run
...
if (file_size(file0) gt 0) then begin & $
   ...
   spawn,'a2ps -1 -r --font-size=8 -Psneezy '+tfile & $
endif

openu,unit,'analysis.log',/get_lun,/append
printf,unit,'pass1            ',file+'all            ',run,run
close,unit
EOF
...
if (file_size(file1) gt 0) then begin & $
   ...
   run='  Y   ' & $
   spawn,'a2ps -1 -r --font-size=8 -Psneezy '+file1txt & $
endif 
printf,unit,'pars1            ',file1+'      ',run,run
...
if (file_size(file2) gt 0) then begin & $
   ...
   run='  Y   ' & $
   spawn,'a2ps -1 -r --font-size=8 -Psneezy '+file2txt & $
endif 
printf,unit,'pars1            ',file2,run,run
...
if (file_size(file3) gt 0) then begin & $ 
   ...
   run='  Y   ' & $
   spawn,'a2ps -1 -r --font-size=8 -Psneezy '+file3txt & $
endif
printf,unit,'pars1            ',file3+'     ',run,run
...
if (file_size(file4) gt 0) then begin  & $
   ...
   run=' Y   ' & $
   spawn,'a2ps -1 -r --font-size=8 -Psneezy '+file4txt & $
endif
...
if (file_size(file) gt 0) then begin & $
    ...
    spawn,'a2ps -1 -r --font-size=8 -Psneezy '+file+'.postage_stamp.log' & $
    run='  Y   ' & $
endif 
openu,unit,'analysis.log',/get_lun,/append
printf,unit,'postage_stamp    ',file+'         ',run,run
close,unit
free_lun,unit
...
if (file_size(file) gt 0) then begin & $
    plc,file,/quick & $
    spawn,'a2ps -1 -r --font-size=8 -Psneezy '+file+'.plc.log' & $
    run='  Y   ' & $
endif
openu,unit,'analysis.log',/get_lun,/append
printf,unit,'plc              ',file+'           ',run,run
close,unit
free_lun,unit
...
if (file_size(file) gt 0) then begin & $ 
    ...
    spawn,'a2ps -1 -r --font-size=8 -Psneezy '+file+'.spectrum.log' & $
    run='  Y   ' & $
endif
openu,unit,'analysis.log',/get_lun,/append
printf,unit,'xrt_spectrum     ',file+'             ',run,run
close,unit
free_lun,unit
