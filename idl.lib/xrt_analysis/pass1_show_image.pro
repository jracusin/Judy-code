; $Id: pass1_show_image.pro 4.1 1994/08/26 21:46:59 patb Exp $

pro pass1_show_image, pxmin, pxmax, pymin, pymax, pmin, pmax, $
		nokeep=nokeep, new_window=new_win

; name	: pass1_show_image
; Inputs:
...
if show_w lt 0 then begin	;Make new window?
	window,/free,xsize=xsize,ysize=ysize,title='XRT CCD Image'
...
tv,bytscl(image,min=hmin,max=hmax,top=ncolors-1)

window_title = 'File: '+file_ccd
