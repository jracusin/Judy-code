...
PRO htmIntersectRadec, ra, dec, angle, depth, leaflist, numdefault=numdefault
  ...
  dir = !idldir+'htmIndexIDL/bin/'
  defsysv, '!htmIntersectRadec_sofile', dir+'htmIntersectRadec.so'
  defsysv, '!htmIntersectRadec_entry', 'main'

  sofile = !htmIntersectRadec_sofile
  entry  = !htmIntersectRadec_entry
