pro fetch_file_list, dir, files, fnums, $
                     ...
                     nfields=nfields,$
                     front=front, nchar=nchar, allfiles=allfiles, allfnums=allfnums
...
;-
  ...
  if n_params() LT 1 then begin
      print,'-Syntax: fetch_file_list, dir [, files, fnums, start=start, nframes=nframes,run=run, camcol=camcol, rerun=rerun, fieldmin=fieldmin, fieldmax=fieldmax, nfields=nfields, front=front]'
      return
  ENDIF
