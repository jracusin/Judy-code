pro plotsym2, psym, psize, FILL=fill,thick=thick,Color = color
                                ;+
; NAME:
;     PLOTSYM2
; PURPOSE:
...
;      May 2010      Added upright, upleft, downright, downleft arrows
;-
  On_error,2
  ...
  if N_elements(psym) LT 1 then begin
     ...
     print,'       7 - right arrow, 8 - square, 9 - up right arrow '
     print,'       10 - up left arrow, 11 - down right arrow, 12 - down left arrow'
     return
  endif
  ...
  case psym of
     ...
     9: begin                   ; upright arrow
        xarr = [0,1.4,1.4,1.4,0.5] * psize
        yarr = [0,1.4,0.5,1.4,1.4] * psize
     end
     10: begin                   ; upleft arrow
        xarr = [0,-1.4,-1.4,-1.4,-0.5] * psize
        yarr = [0,1.4,0.5,1.4,1.4] * psize
     end
     11: begin                   ; down right arrow
        xarr = [0,1.4,1.4,1.4,0.5] * psize
        yarr = [0,-1.4,-0.5,-1.4,-1.4] * psize
     end
     12: begin                  ; down left arrow
        xarr = [0,-1.4,-1.4,-1.4,-0.5] * psize
        yarr = [0,-1.4,-0.5,-1.4,-1.4] * psize
     end
