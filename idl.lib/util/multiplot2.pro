...
PRO multiplot2, pmulti, help=help, $
                ...
                yupgap=yupgap_in, ydowngap=ydowngap_in,$
                xrightgap=xrightgap_in,xleftgap=xleftgap_in,$
  ...
  if n_elements(yupgap_in) ne 0 then yupgap=yupgap_in
  if n_elements(ydowngap_in) ne 0 then ydowngap=ydowngap_in  
  if n_elements(xrightgap_in) ne 0 then xrightgap=xrightgap_in
  if n_elements(xleftgap_in) ne 0 then xleftgap=xleftgap_in
  ...
  pos[0] = pos[0] + xleftgap
  pos[2] = pos[2] - xrightgap

  pos[1] = pos[1] + ygap
  pos[3] = pos[3] - ygap
  
  pos[1] = pos[1] + yupgap
  pos[3] = pos[3] - ydowngap
