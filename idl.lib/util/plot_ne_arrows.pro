PRO plot_ne_arrows, origin, angle, fracsize=fracsize, offset_frac=offset_frac, $
                    order=order

  IF n_params() LT 1 THEN BEGIN 
      print,'-Syntax: plot_ne_arrows, origin, angle, fracsize=fracsize, offset_frac=offset_frac, order=order'
      return
  ENDIF 
