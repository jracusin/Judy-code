; $Id: ll_arc_distance.pro,v 1.10 2002/02/06 21:45:48 scottm Exp $
;
; Copyright (c) 1992-2002, Research Systems, Inc.  All rights reserved.
;	Unauthorized reproduction prohibited.

FUNCTION LL_ARC_DIST, lon_lat0, arc_dist, az, DEGREES = degs
;+
; NAME:
;	LL_ARC_DIST
;
...
;
  ...
  wn=where(lam lt 0,nwn)
  wp=where(lam gt 0,nwp)
  if nwn gt 0 then lam=(lam mod !pi)+!pi
  if nwp gt 0 then lam=(lam mod !pi)-!pi
